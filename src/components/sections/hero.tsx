  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hero content */}
        <div className="px-6 md:px-12 py-10 md:py-16 flex-1 flex flex-col justify-center">
          <h1
            className="text-[38px] sm:text-[56px] lg:text-[80px] leading-[0.95] font-medium tracking-[-0.02em]"
            style={{
          ...
          >
            ...
            <br />
            <em
              className="italic font-normal text-[44px] sm:text-[64px] lg:text-[92px]"
              style={{
          ...
          {/* Description */}
          <p
            className="mt-5 md:mt-6 text-[16px] md:text-[17px] leading-[1.55] max-w-[540px]"
            style={{ color: 'oklch(0.18 0.01 270)' }}
          >
            {t.hero.descriptionPrefix}{' '}
            <span
              className="px-1.5 py-0.5 text-[13px] md:text-[14px] rounded"
              style={{
          ...
          {/* Buttons */}
          <div className="mt-8 md:mt-10 flex flex-col items-start gap-2">
            <button
      ...
      {/* RIGHT column — hidden on mobile, visible on md+ */}
      <div
        className="hidden md:flex flex-col border-t md:border-t-0"
        style={{ borderColor: 'oklch(0.922 0 0)' }}
      >
        {/* Top location info */}
        <div
      ...
      {/* Trust visible on mobile only — full width below the hero text */}
      <div className="md:hidden border-t" style={{ borderColor: 'oklch(0.922 0 0)' }}>
        <Trust />
      </div>
    </section>
  )
